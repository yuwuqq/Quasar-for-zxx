...
namespace Quasar.Common.Video.Codecs
{
    public class UnsafeStreamCodec : IDisposable
    {
        ...
        /// <summary>
        /// 初始化一个UnsafeStreamCodec类的新实例。
        /// </summary>
        /// <param name="imageQuality">使用的质量在0-100之间。</param>
        /// <param name="monitor">用于图像的显示器。</param>
        /// <param name="resolution">显示器的分辨率。</param>
        ...
        public void Dispose()
        {
            ...
            // 告诉垃圾收集器不要浪费时间来最终处理这个对象，因为我们已经处理了它。
