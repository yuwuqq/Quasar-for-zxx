...
namespace Quasar.Client.Utilities
{
    ...
    public static class NativeMethods
    {
        ...
        /// <summary>
        ///    将对应于矩形像素的颜色数据从指定的源设备上下文传输到目标设备上下文，执行位块传输。
        /// </summary>
        /// <param name="hdc">目标设备上下文的句柄。</param>
        /// <param name="nXDest">目标矩形的最左边的X坐标（单位：像素）。</param>
        /// <param name="nYDest">目标矩形的最上面的Y坐标（像素）。</param>
        /// <param name="nWidth">源和目标矩形的宽度（单位：像素）。</param>
        /// <param name="nHeight">源矩形和目标矩形的高度（单位：像素）。</param>
        /// <param name="hdcSrc">到源设备上下文的句柄。</param>
        /// <param name="nXSrc">源矩形的最左边的X坐标（单位：像素）。</param>
        /// <param name="nYSrc">源矩形的最上面的Y坐标（像素）。/param>
        /// <param name="dwRop">一个栅格操作代码。</param>
        /// <returns>
        ///    如果操作成功,<c>true</c>，否则<c>false</c>。要获得扩展的错误信息，请调用<see cref="System.Runtime.InteropServices.Marshal.GetLastWin32Error"/>。
        /// </returns>
